    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4">
            ...
            <div class="relative">
                ...
                <button type="button" onclick="togglePassword()" tabindex="-1" class="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400 focus:outline-none">
